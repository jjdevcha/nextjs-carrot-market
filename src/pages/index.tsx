  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <div className="block mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </div>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative flex flex-col items-center -mt-14 -mb-5">
            <span className="text-lg font-medium">JJ Cha</span>
            <span className="text-sm text-gray-500">Brisbane, Australia</span>
          </div>
        </div>
      </div>
