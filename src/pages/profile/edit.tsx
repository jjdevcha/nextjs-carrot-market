  ...
  return (
    <Layout canGoBack>
      <div className="py-10 px-4 space-y-4">
        ...
        <button className="mt-5 w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-green-500 focus:outline-none ">
          Update profile
        </button>
      </div>
    </Layout>
