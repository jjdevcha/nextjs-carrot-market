      ...
      <div className="py-10 px-4">
        <div className="flex items-center">
          ...
          <div className="flex flex-col justify-center ml-4">
            <span className="font-bold text-gray-700 text-lg">Steve Jebs</span>
        ...
        <div className="flex justify-around items-center my-12">
          <Link href="/profile/sold">
            <div className="space-y-2 flex flex-col items-center justify-center cursor-pointer group">
              <div className="shadow-sm transition-colors bg-green-500 p-5 rounded-full text-white group-hover:bg-green-600">
                <svg
                  className="w-6 h-6 "
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="text-gray-600 font-semibold">판매내역</span>
            </div>
          </Link>
          <Link href="/profile/bought">
            <div className="space-y-2 flex flex-col items-center justify-center cursor-pointer group">
              ...
              <span className="text-gray-600 font-semibold">구매내역</span>
            </div>
          </Link>
          <Link href="/profile/loved">
            <div className="space-y-2 flex flex-col items-center justify-center cursor-pointer group">
              ...
              <span className="text-gray-600 font-semibold">관심목록</span>
            </div>
          </Link>
        </div>
        <div>
